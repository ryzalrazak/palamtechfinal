...
def addpackage():
    rcasing = db.engine.execute("SELECT id, name, price FROM casing ORDER BY name")
    rmobo = db.engine.execute("SELECT id, name, price FROM mb ORDER BY name")
    rgpu = db.engine.execute("SELECT id, name, price FROM gpu ORDER BY name")
    rram = db.engine.execute("SELECT id, name, price FROM ram ORDER BY name")
    rstorage = db.engine.execute("SELECT id, name, price FROM ssd ORDER BY name")
    rpsu = db.engine.execute("SELECT id, name, price FROM psu ORDER BY name")
    rcpu = db.engine.execute("SELECT id, name, price FROM cpu ORDER BY name")
